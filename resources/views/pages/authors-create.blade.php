        ...
        <div class="max-w-2xl">
          <div class="bg-white rounded-xl shadow overflow-hidden">
            ...
            <form method="POST" action="{{ route('authors.store') }}" class="p-6 space-y-6">
              @csrf
              <div>
                <label for="author_name" class="block text-sm font-medium text-gray-700 mb-2">Author Name<span
              ...
              <div>
                <label for="author_email" class="block text-sm font-medium text-gray-700 mb-2">Email<span
                    class="text-red-500">*</span></label>
              ...
              <div>
                <label for="author_bio" class="block text-sm font-medium text-gray-700 mb-2">Biography</label>
              ...
              <div>
                <label for="author_status" class="block text-sm font-medium text-gray-700 mb-2">Status</label>
