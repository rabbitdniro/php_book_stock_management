      ...
      <header class="bg-white shadow-sm sticky top-0 z-20">
        <div class="px-6 lg:px-8 py-4 flex items-center justify-between">
          <div class="flex items-center space-x-4">
            ...
            <div>
              <h1 class="text-xl font-bold text-gray-800">Update Book</h1>
              <p class="text-sm text-gray-500">Update an existing book in the collection</p>
            </div>
          </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input type="text" id="book_isbn" name="book_isbn" required
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                    placeholder="978-0-7475-3269-9" value="{{ $book->ISBN }}" />
                </div>
              </div>
                ...
                <div>
                  ...
                  <select id="book_category_name" name="book_category_id" required
                    ...
                    @foreach ($categories as $id => $name)
                      <option value="{{ $id }}" {{ $book->category_id == $id ? 'selected' : '' }}>{{ $name }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" id="book_publication_year" name="book_publication_year" required
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                    placeholder="Enter book publication year" value="{{ $book->publication_date }}" />
                </div>
                ...
                <div>
                  ...
                  <input type="text" id="book_stock_quantity" name="book_stock_quantity" required
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors"
                    placeholder="Enter book stock" value="{{ $book->stock_quantity }}" />
                </div>
              </div>
  ...
  @if(isset($book) && $book->cover_image)
    <script>
      document.addEventListener('DOMContentLoaded', function () {
        ...
        const imageUrl = "{{ asset('storage/' . $book->cover_image) }}";
