    ...
    <aside class="lg:w-64 bg-white shadow-lg z-10 lg:h-screen lg:sticky lg:top-0">
      ...
      <div class="p-4">
        <nav class="space-y-1">
          ...
          <a href="{{ route('authors.index') }}" class="flex items-center space-x-3 p-3 rounded-lg sidebar-link active">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <table class="w-full">
              <thead class="bg-gray-50 border-b">
                <tr>
                  ...
                  <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Email
                  </th>
                  <th class="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Books
                    Count</th>
              ...
              <tbody class="divide-y divide-gray-200">
                @foreach ($authors as $author)
                  <tr class="hover:bg-gray-50 transition-colors">
                    ...
                    <td class="px-6 py-4 text-sm text-gray-600">{{ $author->books_count ?? 0 }}</td>
                    <td class="px-6 py-4">
                      <span
                        class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">{{ $author->status }}</span>
                    </td>
                    <td class="px-6 py-4">
